    ...
    documents: [
      {
        ...
        widthMm: 35, heightMm: 45, widthPx: 413, heightPx: 531, dpi: 300,
        background: 'Plain white or light grey', bgColor: '#ffffff', bgColorLabel: 'White',
        requirements: ['Size: 35×45 mm', 'Plain white or light grey background', 'Neutral expression, mouth closed', 'Eyes open and clearly visible', 'No glasses', 'Head straight and centered', 'Face must cover 70–80% of the frame', 'Taken within the last 6 months', 'ICAO biometric compliant'],
        seoTitle: 'Free Schengen Visa Photo Maker | 35×45mm | No Watermark | Free',
        seoDescription: 'Create a compliant Schengen visa photo online for free. Correct 35×45mm biometric size for all EU countries. No registration, no watermark. Instant JPG or PDF download.',
        h1: 'Free Schengen Visa Photo Maker',
        faq: [
          { q: 'What size is a Schengen visa photo?', a: 'Schengen visa photos must be 35 mm wide and 45 mm tall. This standard applies to all 27 Schengen area countries.' },
          { q: 'Which countries accept the Schengen photo format?', a: 'All 27 EU Schengen countries including Germany, France, Italy, Spain, Netherlands, Belgium, Austria, Switzerland, and others.' },
          { q: 'What background color is required?', a: 'The background must be plain white or very light grey. No textures, patterns, or shadows.' },
          { q: 'Can I wear glasses in a Schengen visa photo?', a: 'No. As of 2015, glasses are not permitted in biometric passport or visa photos within the EU.' },
          { q: 'Can I use this photo for a German, French, or Italian passport?', a: 'Yes. The 35×45mm biometric format is the standard for all EU national passports and Schengen visas.' },
          { q: 'Is my photo uploaded to your servers?', a: 'No. All processing happens entirely in your browser. Your photo never leaves your device.' },
        ],
      },
    ],
